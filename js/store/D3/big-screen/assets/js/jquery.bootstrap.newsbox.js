...
(function ($, w, d, undefined) {
  ...
  var NewsBox = {
    ...
    onStop: function() {
      //enable users to override the methods
      if( typeof self.options.onStop === 'function') {
        self.options.onStop.apply(self, []);
      }
    },
    ...
    onPause: function() {
      ...
      //enable users to override the methods
      if( typeof self.options.onPause === 'function') {
        self.options.onPause.apply(self, []);
      }
    },
    ...
    onReset: function(status) {
      ...
      if( typeof self.options.onReset === 'function') {
        self.options.onReset.apply(self, []);
      }
    },
    ...
    onPrev: function() {
      ...
      if( typeof self.options.onPrev === 'function') {
        self.options.onPrev.apply(self, []);
      }
    ...
    onNext: function() {
      ...
      if( typeof self.options.onNext === 'function') {
        self.options.onNext.apply(self, []);
      }
    }
  };
